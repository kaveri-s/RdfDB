...
public class BPIoBuf implements GlobalConst{
  /**
   ...
   *@exception Exception other exceptions
   */
  public BasicPattern Get(BasicPattern  buf)
    throws IOException,
	   Exception
    {
      BasicPattern tempbaBasicPattern;
      if (done){
	buf =null;
	return null;
      }
	...
	{
	  // get tuples from 
	  if ((tempbaBasicPattern= i_buf.Get(buf)) == null)
	    {
	      done = true;
	      return null;
	    }
  ...
  private  BPSpoofIbuf i_buf;        // gets input from a temporary file
}
