...
//import btree.*;
   ...
   */
class QuadBTreeHeaderPage extends THFPage {
   ...
   */
  public QuadBTreeHeaderPage(PageId pageno) 
  ...
  public QuadBTreeHeaderPage(Page page) {
