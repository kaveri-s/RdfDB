...
//import btree.*;
  ...
  /**
   * Interface of a label B+ tree index header page.  
   * Here we use a LHFPage as head page of the file
   ...
   */
class LabelBTreeHeaderPage extends LHFPage {
   ...
   */
  public LabelBTreeHeaderPage(PageId pageno) 
  ...
  public LabelBTreeHeaderPage(Page page) {
